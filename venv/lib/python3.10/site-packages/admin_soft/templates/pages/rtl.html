              ...
              <div class="row">
                <div class="col-lg-6 mb-lg-0 mb-4">
                  <div class="d-flex flex-column h-100">
                    ...
                    <h5 class="font-weight-bolder">Parish Retail Dashboard</h5>
                ...
                <div class="col-lg-4 me-auto ms-0 text-center">
                  <div class="bg-gradient-primary border-radius-lg min-height-200">
                    <img src="{% static 'img/shapes/waves-white.svg' %}" class="position-absolute h-100 top-0 d-md-block d-none" alt="waves">
                    <div class="position-relative pt-5 pb-4">
                      <img class="max-width-500 w-100 position-relative z-index-2" src="{% static 'img/illustrations/rocket-white.png' %}">
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Parish Retail XD الإصدار</h6>
                          </div>
                        </div>
                      </td>
                      <td>
